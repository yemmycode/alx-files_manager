...
export default class FilesController {
  ...
  static async postUpload(req, res) {
    ...
    // If not provided, baseDir defaults to '/tmp/files_manager' (Unix) or '%USERPROFILE%/AppData/Local/Temp/files_manager' (Windows).
    const newFile = {
    ...
    // Start a worker to generate a thumbnail for image files.
  ...
  /**
   * Fetches all files for a specific user.
   * @param {Request} req The Express request object.
   * @param {Response} res The Express response object.
   */
  ...
  /**
   * Deletes a file or folder based on the given ID.
   * @param {Request} req The Express request object.
   * @param {Response} res The Express response object.
   */
  static async deleteFile(req, res) {
    ...
    // Delete file or folder data from the local system if it's a file.
    if (file.type !== VALID_FILE_TYPES.folder && file.localPath) {
